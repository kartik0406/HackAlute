...
router.post("/register", upload.single('myImage'),function(req,res){
    ...
    var newUser = new User({username: req.body.username, about: req.body.about, skills:req.body.skills,img: finalImg,xp:0,credits:0, email:req.body.email, institute:req.body.institute, language:req.body.language, github:req.body.github, linkedIn:req.body.linkedIn});
